...
class DramaController extends GetxController with BaseControllerMixin {
  @override
  String get builderId => 'drama';
  List<String> urls = [
    'https://ddys.pro/category/drama/',
    'https://ddys.pro/category/drama/western-drama/',
    'https://ddys.pro/category/drama/jp-drama/',
    'https://ddys.pro/category/drama/kr-drama/',
    'https://ddys.pro/category/drama/cn-drama/',
    'https://ddys.pro/category/drama/other/'
  ];
